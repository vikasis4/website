...
export default function index() {
	return (
		<form method="POST" name="customerData" action="https://wbb.rankboost.live/ccavRequestHandler">
			...
			<table width="40%" align="center">
				...
				<tr>
					<td>Merchant Id</td>
					<td><input type="text" name="merchant_id" id="merchant_id" value="2484275" /> </td>
				</tr>
				<tr>
					<td>Order Id</td>
				...
				<tr>
					...
					<td><input type="text" name="redirect_url"
						value="https://wbb.rankboost.live/ccavResponseHandler" />
					</td>
				</tr>
				<tr>
					<td>Cancel URL</td>
				...
				<tr>
					<td>Shipping information(optional):</td>
				</tr>
				<tr>
					<td>Shipping Name</td>
